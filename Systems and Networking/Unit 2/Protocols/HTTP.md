...
The **HyperText Transfer Protocol** is the main [application-layer](/Systems and Networking/Unit 2/Internet/Layered Structure.md#Application) protocol used in the **Web**. HTTP has been developed to permit the exchange of documents between hosts through the web.
